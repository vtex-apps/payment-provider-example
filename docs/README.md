...
Further information on [Secure Proxy RFC](https://www.notion.so/Secure-Proxy-32bb36fdb3634ff39df524f391ad0d71)
...
Now that we have a new connector ready to use, we can test it entirely in the production flow using your store's checkout.
